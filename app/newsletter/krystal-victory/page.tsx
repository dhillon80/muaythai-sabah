  ...
  return (
    <main className="min-h-screen bg-slate-950 text-gray-100 font-sans selection:bg-red-600 relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/40 backdrop-blur-md border-b border-white/5 px-6 py-4 flex justify-between items-center">
        <Link href="/" className="text-[10px] font-black uppercase tracking-[0.3em] hover:text-red-500 italic transition-all">← BACK TO HUB</Link>
      ...
      <div className={`relative z-10 max-w-5xl mx-auto pt-40 pb-20 px-6 transition-all duration-1000 ${mounted ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-40">
          <div className="md:col-span-8 space-y-10 text-gray-300 text-lg md:text-xl leading-relaxed">
            ...
            <p>
              Representing <strong>Team Karabaw Tamparuli</strong>, Krystal Angel stepped into the ring to face Reese Rae under the prestigious <strong>Coastal Combat</strong> banner. The strategy was clear, forged through the elite experience of her trainers and brothers—ex-SUKMA champions <strong>Kenny Jafili</strong> and <strong>Kallen Jafili</strong>.
            </p>

            <p>
              Krystal effectively neutralized Rae&apos;s reach advantage with clinical clinch work and explosive power, showcasing the superior technical refinement she has achieved in recent camps. The win was decisive, proving her readiness for the national and international stage alike.
            </p>

            <div className="bg-red-600/10 p-8 rounded-2xl border border-red-600/20 italic text-white shadow-xl">
              <p>
                Krystal Angel is a core member of the <strong>Sabah Fight Squad for SUKMA 2026</strong>, continuing the championship legacy and footsteps of her brothers.
              </p>
            </div>
          </div>
        ...
        <section className="mb-40">
          ...
          <div className="mt-12 text-center space-y-2">
            <p className="text-[9px] font-black text-gray-700 uppercase tracking-[0.6em] italic">
              Photography Credits
            </p>
            <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.4em]">
              Coastal Combat FB Page &bull; PGX FB Page
            </p>
          </div>
        </section>
        ...
        <footer className="text-center pt-20 border-t border-white/5">
          <Link href="/" className="group inline-flex flex-col items-center gap-8">
...
export default KrystalVictoryPage;