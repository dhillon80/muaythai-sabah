  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#050506] text-white p-6 md:p-12 font-sans selection:bg-yellow-500 print:bg-white print:text-black print:p-0 print:h-screen print:overflow-hidden">
        ...
        {/* Main Print Container - SCALED TO FIT */}
        <div className="max-w-6xl mx-auto print:max-w-none print:w-full print:scale-[0.95] print:origin-top">
          
          {/* PRINT HEADER: Clean & Compact */}
          <div className="hidden print:flex justify-between items-end border-b-2 border-black pb-2 mb-6">
             <div>
                <h1 className="text-4xl font-black uppercase tracking-tight leading-none text-black">
                  {fighter.name}
                </h1>
                <p className="text-lg font-mono font-bold text-gray-600 mt-1">"{fighter.nickname}"</p>
             </div>
             <div className="text-right">
                <span className="block text-3xl font-black italic">{fighter.record}</span>
          ...
          <div className="flex flex-col md:flex-row gap-12 print:flex-row print:gap-8 print:items-start">
            
            {/* === LEFT COLUMN (SIDEBAR) === */}
            <div className="w-full md:w-5/12 flex flex-col gap-6 print:w-[35%] print:flex-none print:gap-4">
              
              {/* Image - Full Color & Constrained */}
              ...
              {/* PRINT SIDEBAR: Stats Table */}
              <div className="hidden print:block bg-gray-50 p-3 rounded border border-gray-200 text-xs">
              ...
              {/* PRINT SIDEBAR: Contact */}
              <div className="hidden print:block text-xs">
                 <div className="mb-3">
                   <span className="block font-black uppercase tracking-wider text-[10px] text-gray-500 mb-1">Team</span>
                   <span className="block font-bold leading-tight">{fighter.team}</span>
                 </div>
                 <div className="mb-3">
                   <span className="block font-black uppercase tracking-wider text-[10px] text-gray-500 mb-1">Coach / Manager</span>
                   <span className="block font-bold leading-tight">{fighter.coach}</span>
                 </div>
                 <div>
                   <span className="block font-black uppercase tracking-wider text-[10px] text-gray-500 mb-1">Booking Contact</span>
            ...
            <div className="w-full md:w-7/12 pt-4 print:flex-1 print:pt-0">
              ...
              {/* BIOGRAPHY (Print Optimized - Auto-Justify & Compact) */}
              ...
              {/* ACHIEVEMENTS (Print Optimized - Columns & Compact) */}
              ...
              {/* PRINT FOOTER - Forced to Bottom */}
              <div className="hidden print:block mt-8 pt-2 border-t border-gray-300 text-center text-[8px] text-gray-500 print:break-inside-avoid">
